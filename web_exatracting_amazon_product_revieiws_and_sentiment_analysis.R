setwd("E:/Excel_R_Data Science/Assignments/11. Text Mining")
...
# Amazon Reviews #############################
aurl <- "https://www.amazon.in/Redmi-6A-Black-2GBRAM-Storage/product-reviews/B077PW9V3J/ref=cm_cr_arp_d_paging_btm_next_2?pageNumber"
amazon_reviews <- NULL
for (i in 1:10){
...
write.table(amazon_reviews,"redmi_6A.txt",row.names = F)
...
sad_items <- which(nrc_data$positive > 0)
head(s_v[sad_items])
